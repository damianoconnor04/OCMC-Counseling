...
export default function Blob({ className }: { className: string }) {
	return (
		<svg width="1034" height="1021" viewBox="0 0 1034 1021" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
			...
			<defs>
				...
				<linearGradient id="paint0_linear_3_3" x1="-55.1272" y1="518.558" x2="512.17" y2="1099.11" gradientUnits="userSpaceOnUse">
					<stop stopColor="#FFD888" />
